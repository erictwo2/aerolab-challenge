<template>
  <div class="flex flex-wrap md:flex-no-wrap items-center justify-between mx-auto pt-5 pb-5 mt-16">
    <div class="flex items-center">
      <span class="text-2xl font-normal tracking-tight mr-3">16 of 32 products | Sort by:</span> 
    ...
    <div class="flex items-center">
      <img src="arrow-left.svg" class="mr-3"/>
