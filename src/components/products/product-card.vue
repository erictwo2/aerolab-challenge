    ...
    <client-only>
      <kinesis-container>
        <kinesis-element :strength="5">
          <article
            class="overflow-hidden rounded-sm shadow-md border border-gray-200 transition duration-500 ease-in-out transform hover:border-active hover:border-opacity-75 hover:-translate-y-4 hover:shadow-2xl"
          ...
          >
            ...
            <div
              v-if="hover && canRedeem >= 0"
              class="bg-opacity-75 bg-active z-10 absolute top-0 left-0 w-full h-full"
            >
...
export default class ProductCard extends Vue {
  ...
  get canRedeem() {
    ...
    return userModule.user ? userModule.user.points - this.product.cost : null;
  }
